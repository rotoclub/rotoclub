...
class Partner(models.Model):
    ...
    def check_vat(self):
        ...
        for partner in self:
            ...
            # Add country.check_vat condition to no validate Vat for the country that has not check the field
    ...
    #             obj_lang_inactive_ids = self.env['res.lang'].search([('code', '=', lang_value),
    #                                                                  ('active', '=', False)])
